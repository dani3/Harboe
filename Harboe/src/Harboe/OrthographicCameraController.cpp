...
namespace Harboe
{
	...
	void OrthographicCameraController::OnEvent(Event& e)
	{
		...
		dispatcher.Dispatch<MouseScrolledEvent>(HB_BIND_EVENT_FN(OrthographicCameraController::OnMouseScrolled));
		dispatcher.Dispatch<WindowResizeEvent>(HB_BIND_EVENT_FN(OrthographicCameraController::OnWindowResized));
	}
